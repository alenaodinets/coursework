from coursework.src.functions import format_operation, modify_date, modify_from, modify_to, sorted_list
import pytest
...
def test_modify_to():
    ...
    assert modify_to("Счет 65778657373636465777") == "Счет **5777"
